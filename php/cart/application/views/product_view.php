	...
	<div class="container"><br/>
		<h2 class="jumbotron">Rent Games Shopping Cart</h2>
		<hr/>
		<div class="row">
			<div class="col-md-8">
				<h4>Product</h4>
					...
					<div class="col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<br>
								<button class="add_cart btn btn-light btn-block" data-productid="<?php echo $row->product_id;?>" data-productname="<?php echo $row->product_name;?>" data-productprice="<?php echo $row->product_price;?>">Add To Cart</button>
							</div>
						</div>
					</div>
				<?php endforeach;?>
